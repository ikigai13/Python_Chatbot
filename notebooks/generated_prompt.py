def prompt_template(data: str, num_records: int = 5):
    ...
    Q&A pair should be concise yet informative, capturing key insights from the data, and include basics examples of python coding from the data.
    ...
    Focus on creating clear, relevant, and varied questions and short simple executable python code that encourage the model to learn from diverse perspectives. Avoid any sensitive or biased 
...
if __name__ == "__main__":
    print(prompt_template("nixon", 10))
